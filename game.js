	...
	var poleGroup; 
     ...
     play.prototype = {
		preload:function(){
			...
			game.load.image("ninja", "/assets/img/PNG/Special/brickSpecial08.png"); 
			game.load.image('background', '/assets/img/BG.png');

			game.load.image("pole", "pole-special.png");
               game.load.image("powerbar", "powerbar.png");
			game.load.spritesheet('waters', 'water-layer-1.png');
			game.load.spritesheet('waters-1', 'water-layer2.png');
		},
		create:function(){
			// game.add.tileSprite(0, 0, innerWidth, innerHeight, 'background');
			bgtile = game.add.tileSprite(0, -200, 1280, 720, 'background');
			...
			addPole(80);
				waterLayer1 = game.add.tileSprite(0, 435, 1280, 32, 'waters-1');

				waterLayer = game.add.tileSprite(0, 450, 1280, 32, 'waters');
